...
public class Emprunt {
    ...
    public void setDateRetourEffective(Date dateRetourEffective) throws NosExceptions {
        if (dateRetourEffective != null) {
            if (this.dateRetourEffective.compareTo(dateEmprunt) > 0) {
                throw new NosExceptions("La date de retour effective ne doit pas être avant la"
                        + " date d'emprunt");
            }
        }
    ...
    public void setDateEmprunt(Date dateEmprunt) throws NosExceptions {
        if (null == dateEmprunt) {
            throw new NosExceptions("Veuillez renseigner la date d'emprunt");
        }
        this.dateEmprunt = dateEmprunt;
    }
    ...
    public void setDateRetourPrevu(Date dateRetourPrevu) throws NosExceptions {
        if (this.dateEmprunt.compareTo(dateRetourPrevu) > 0) {
            throw new NosExceptions("La date de retour prévu ne doit pas être avant"
                    + " la date d'emprunt");
        }
        this.dateRetourPrevu = dateRetourPrevu;
    }
     ...
     * @throws NosExceptions Une exception en cas d'erreurs
     */
    public void emprunter(Usager usager, Oeuvre oeuvre, Exemplaire exemplaire, Date dateJour) throws NosExceptions {
        Emprunt emprunt = findEmpruntNonRendu(usager, oeuvre);
        if (null != emprunt) {
            throw new NosExceptions("Vous avez un emprunt d'exemplaire de cette oeuvre non rendu\n"
        ...
        try {
            ...
            if (statut == 0) {
                throw new NosExceptions("Echec lors de l'enregistrement de l'emprunt");
            }
        } catch (SQLException e) {
            throw new NosExceptions("Erreurs lors de l'enregistrement de l'emprunt", e.getCause());
    ...
    public void delete(Exemplaire exemplaire) throws NosExceptions {
        ...
        } catch (/*SQLException | NosExceptions e*/ Exception e) {
            throw new NosExceptions("Erreurs lors de la suppression des emprunts de l'exemplaire ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
    ...
    public Emprunt findEmpruntNonRendu(Usager usager, Oeuvre oeuvre) throws NosExceptions {
    ...
    public ArrayList<Emprunt> findEmprunts(Oeuvre oeuvre) throws NosExceptions {
        final String SQL_SELECT_BY_ID_OEUVRE_USAGER = "SELECT emp.*, u.Nom, u.Prenom, o.id, o.Titre, o.Auteur"
                + " FROM emprunt emp, exemplaire e, usager u, oeuvre o"
                + " WHERE emp.ExemplaireId = e.id"
                + " AND emp.UsagerID = u.id"
    ...
    public Emprunt find(Usager usager, int idExemplaire, Oeuvre oeuvre) throws NosExceptions {
    ...
    public void Rendre(Emprunt emprunt) throws NosExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new NosExceptions("Echec de l'enregistrement du retour de l'exemplaire");
            }
        } catch (SQLException e) {
            throw new NosExceptions("Erreurs lors de l'enregistrement du retour de l'exemplaire ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    private ArrayList<Emprunt> find(String sql, Object... objets) throws NosExceptions {
        PreparedStatement preparedStatement = null;
