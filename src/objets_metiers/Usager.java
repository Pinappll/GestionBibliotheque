...
public class Usager {
    ...
    public void setId(int id) throws NosExceptions {
        if (id <= 0) {
            throw new NosExceptions("Identifiant Usager non valide !");
        }
        this.id = id;
    }
    ...
    public void setNom(String nom) throws NosExceptions {
        if (null != nom) {
            if (nom.length() < 2) {
                throw new NosExceptions("Le nom de l'usager doit contenir "
                        + "au moins 3 caractères");
            }
        } else {
            throw new NosExceptions("Merci de saisir le nom de l'usager");
        }
        this.nom = nom;
    }
    ...
    public void setPrenom(String prenom) throws NosExceptions {
        if (null != prenom) {
            if (prenom.length() < 3) {
                throw new NosExceptions("Le prénom de l'usager doit contenir "
                        + "au moins 3 caractères");
            }
        } else {
            throw new NosExceptions("Merci de saisir le prénom de l'usager");
        }
        this.prenom = prenom;
    }
    ...
    public void setSexe(String sexe) throws NosExceptions {
        if (null == sexe) {
            throw new NosExceptions("Merci de préciser le sexe de l'usager");
        }
        this.sexe = sexe;
    }
    ...
    public void setAdresse(String adresse) throws NosExceptions {
        if (null != adresse) {
            if (adresse.length() < 5) {
                throw new NosExceptions("L'adresse doit contenir "
                        + "au moins 10 caractères");
            }
        } else {
            throw new NosExceptions("Merci de renseigner l'adresse de l'usager");
        }
        this.adresse = adresse;
    }
    ...
    public void setTel(String tel) throws NosExceptions {
        if (null != tel) {
            if (tel.length() < 10) {
                throw new NosExceptions("Le numero de téléphone doit se composer \n"
                        + "au moins de 10 chiffres");
            }
        } else {
            throw new NosExceptions("Merci de saisir un numéro de téléphone ");
        }
        this.tel = tel;
    }

    public void ajouter(Usager usager) throws NosExceptions {
        ...
        try {
            ...
            if (statut == 0) {
                throw new NosExceptions("Erreurs lors de l'ajout d'un usager");
            }

        } catch (SQLException | NosExceptions e) {
            throw new NosExceptions("Erreurs lors de l'ajout d'un usager", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public void modifier(Usager usager) throws NosExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new NosExceptions("Echec de la mise à jour de l'usager");
            }
        } catch (SQLException | NosExceptions e) {
            throw new NosExceptions("Erreurs lors de la mise à jour de l'usager ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public void delete(Usager usager) throws NosExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new NosExceptions("Echec de la suppression de l'usager");
            }
        } catch (SQLException | NosExceptions e) {
            throw new NosExceptions("Erreurs lors de la suppression de l'usager ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
     ...
     */
    public ArrayList<Usager> getListUsagers() throws NosExceptions {
     ...
     * @throws NosExceptions
     */
    public Usager findById(int id) throws NosExceptions {
     ...
     * @throws NosExceptions
     */
    public ArrayList<Usager> findByNom(String nom) throws NosExceptions {
    ...
    private ArrayList<Usager> find(String sql, Object... objets) throws NosExceptions {
        PreparedStatement preparedStatement = null;
        ...
        try {
            ...
            throw new NosExceptions("Aucun enregistrement trouvé " + e.getMessage());
        } finally {
