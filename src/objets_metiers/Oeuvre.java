...
public class Oeuvre {
    ...
    public void setId(int id) throws NosExceptions {
        if (id <= 0) {
            throw new NosExceptions("Identifiant Oeuvre non valide !");
        }
        this.id = id;
    }
    ...
    public void setCategorie(String categorie) throws NosExceptions {
        if (null != categorie) {
            if (categorie.length() < 3) {
                throw new NosExceptions("Le nom de la catégorie doit contenir "
                        + "au moins 3 caractères");
            }
        } else {
            throw new NosExceptions("Merci de saisir une catégorie ");
        }
    ...
    public void setAuteur(String auteur) throws NosExceptions {
        if (null != auteur) {
            if (auteur.length() < 3) {
                throw new NosExceptions("Le nom de l'auteur doit avoir "
                        + "au moins 3 caractères");
            }
        } else {
            throw new NosExceptions("Merci de saisir un nom ");
        }
        this.auteur = auteur;
    }
    ...
    public void setTitre(String titre) throws NosExceptions {
        if (null != titre) {
            if (titre.length() < 3) {
                throw new NosExceptions("Le titre doit avoir "
                        + "au moins 3 caractères");
            }
        } else {
            throw new NosExceptions("Merci de saisir le titre de l'oeuvre ");
        }
        this.titre = titre;
    }
    ...
    private boolean oeuvreExiste(Oeuvre oeuvre) throws NosExceptions {
    ...
    public void ajouter(Oeuvre oeuvre) throws NosExceptions {

        if (oeuvreExiste(oeuvre)) {
            throw new NosExceptions("Cette oeuvre est déjà ajoutée");
        }
        ...
        try {
            ...
            if (statut == 0) {
                throw new NosExceptions("Echec d'ajout de l'oeuvre");
            }

        } catch (SQLException | NosExceptions e) {
            throw new NosExceptions("Erreurs lors de l'ajout de l'oeuvre", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public void modifier(Oeuvre oeuvre) throws NosExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new NosExceptions("Echec de la mise à jour de l'oeuvre");
            }
        } catch (SQLException e) {
            throw new NosExceptions("Erreurs lors de la mise à jour de l'oeuvre ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
     ...
     */
    public ArrayList<Oeuvre> getListOeuvres() throws NosExceptions {
     ...
     * @throws NosExceptions
     */
    public Oeuvre findById(int id) throws NosExceptions {
...
//    public static Oeuvre findByTitre(String titre) throws NosExceptions {
...
//        return oeuvres.isEmpty() ? null : oeuvres.get(0);
//    }
    public ArrayList<Oeuvre> findByTitre(String titre) throws NosExceptions {
    ...
    private ArrayList<Oeuvre> find(String sql, Object... objets) throws NosExceptions {
        PreparedStatement preparedStatement = null;
        ...
        try {
            ...
            throw new NosExceptions("Aucune oeuvre trouvée " + e.getMessage());
        } finally {
    ...
    public void delete(Oeuvre oeuvre) throws NosExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new NosExceptions("Echec de la suppression de l'oeuvre");
            }
        } catch (SQLException | NosExceptions e) {
            throw new NosExceptions("Erreurs lors de la suppression de l'oeuvre ", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }
     ...
     * @throws NosExceptions
     */
//    public boolean estReservable() throws NosExceptions {
