...
//                + " AND ";
    ...
    public void setId(int id) throws NosExceptions {
        if (id <= 0) {
            throw new NosExceptions("Identifiant Reservation non valide !");
        }
        this.id = id;
    }
    ...
    public void reserver(Usager usager, Oeuvre oeuvre, Date dateJour) throws NosExceptions {
        Reservation reservation = findByReservation(usager, oeuvre);
        if (null != reservation) {
            throw new NosExceptions("Vous avez déjà réservé l'oeuvre '" + oeuvre.getTitre()
        ...
        try {
            ...
            if (statut == 0) {
                throw new NosExceptions("Echec lors de l'enregistrement de la réservation");
            }
        } catch (SQLException e) {
            throw new NosExceptions("Erreurs lors de l'enregistrement de la réservation", e.getCause());
    ...
    public void annuler(Usager usager, Oeuvre oeuvre, Reservation reservation) throws NosExceptions {
        ...
        try {
            ...
            int statut = preparedStatement.executeUpdate();
            if (statut == 0) {
                throw new NosExceptions("Echec de l'annulation de la réservation");
            }
        } catch (SQLException | NosExceptions e) {
            throw new NosExceptions("Erreurs lors de  l'annulation de la réservation", e.getCause());
        } finally {
            closeStatement(preparedStatement);
        }
    }

    public Reservation findById(int id) throws NosExceptions {
    ...
    public ArrayList<Reservation> findByDateReservaton(Date dateRes) throws NosExceptions {
    ...
    public Reservation findByReservation(Usager usager, Oeuvre oeuvre) throws NosExceptions {
    ...
    public ArrayList<Reservation> findByReservation(Oeuvre oeuvre) throws NosExceptions {
    ...
    private ArrayList<Reservation> find(String sql, Object... objets) throws NosExceptions {
        PreparedStatement preparedStatement = null;
