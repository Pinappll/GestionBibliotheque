...
public class ReservationControl {
    ...
    public static void reserver(int idUsager, String titre) throws NosExceptions {
        Usager usager = new Usager();
        usager = usager.findById(idUsager);
        if (null == usager) {
            throw new NosExceptions("L'usager n'est pas enregistré");
        }
    ...
    public static void annuler(int idUsager, String titre)
        ...
        if (null == reservation) {
            throw new NosExceptions("Aucune réservation de l'oeuvre '" + oeuvre.getTitre() + "'\n"
    ...
    public static Reservation findById(int id) throws NosExceptions {
        Reservation reservation = new Reservation();
        return reservation.findById(id);
    }
    
    public static ArrayList<Reservation> findByDateReservaton(Date dateReservation) throws NosExceptions{
        Reservation reservation = new Reservation();
        return reservation.findByDateReservaton(dateReservation);
    }
    
    public static Reservation findByReservation(Usager usager, Oeuvre oeuvre) throws NosExceptions {
        Reservation reservation = new Reservation();
        return reservation.findByReservation(usager, oeuvre);
    }
    
    public static ArrayList<Reservation> findByReservation(Oeuvre oeuvre) throws NosExceptions {
        Reservation reservation = new Reservation();
