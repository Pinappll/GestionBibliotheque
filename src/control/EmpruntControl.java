...
public class EmpruntControl {
    ...
    public static void emprunter(int id, String titre) throws NosExceptions {
        ...
        if(null == exemplaire){
            throw new NosExceptions("Aucun exemplaire de l'oeuvre '" 
    ...
    public static void rendre(Emprunt emprunt) throws NosExceptions {
        emprunt.Rendre(emprunt);
    }
    
    public static void rendre(String nom, int idOeuvre, int idExemplaire) throws NosExceptions {
        Usager usager = new Usager();
        ...
        if (null == exemplaire) {
            throw new NosExceptions("L'exemplaire n'existe pas");
        }
        Emprunt emprunt = new Emprunt().find(usager, exemplaire.getId(), oeuvre);
        if (null == exemplaire) {
            throw new NosExceptions("L'emprunt n'existe pas");
        }
        emprunt.Rendre(emprunt);
    }
    
    public static ArrayList<Emprunt> findEmprunts(Oeuvre oeuvre) throws NosExceptions {
        Emprunt emprunt = new Emprunt();
